...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('blog.insert.post') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <input class="form-control" type="date" name="submit_date">
                <br>
