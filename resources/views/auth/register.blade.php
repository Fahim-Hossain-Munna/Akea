    ...
    <div class="app app-auth-sign-up align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <div class="auth-credentials m-b-xxl">
                ...
                <input type="text" class="form-control m-b-md @error('name') is-invalid @enderror"  name="name" placeholder="Enter Name">
                @error('name')
                ...
                <input type="email" class="form-control m-b-md @error('email') is-invalid @enderror" name="email" placeholder="example@neptune.com">
                @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
